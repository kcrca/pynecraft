...
class DataPack:
    ...
    def __init__(self, name: str, desc: TextDef = None, max_format: Version = None, min_format: Version = None,
        ...
        self._json = {}
        max_format = as_version(max_format, DATA_PACK_VERSION)
    ...
    def save(self, path: Path | str):
        ...
        to start with a clean slate. It then writes all the files, as well as the ``pack.mcmeta`` file and a
        warning ``README`` file.
        """
        ...
        if self.tick_functions or self.load_functions:
            ...
            mc_tags = path / 'data' / 'minecraft' / 'tags' / 'function'
