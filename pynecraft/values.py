...
# Generated from Minecraft 26.2-snapshot-5 jar data, 2026-05-03T18:12:29-07:00
...
team_options = {
    "COLLISION_RULE": TeamOptionInfo("""collision Rule""", "collisionRule", None,
                                     ['always', 'never', 'pushOtherTeams', 'pushOwnTeam']),
    "COLOR": TeamOptionInfo("""color""", "color", None, 'Nbt'),
    "DEATH_MESSAGE_VISIBILITY": TeamOptionInfo("""death Message Visibility""", "deathMessageVisibility", None,
    ...
    "NAMETAG_VISIBILITY": TeamOptionInfo("""nametag Visibility""", "nametagVisibility", None,
                                         ['always', 'hideForOtherTeams', 'hideForOwnTeam', 'never']),
...
ADVANCEMENT_GROUP = [
    ...
    CRAFTING_A_NEW_LOOK, DIAMONDS, ENCHANTER, EYE_SPY, FEELS_LIKE_HOME, FISHY_BUSINESS, FREE_THE_END,
    ...
    THE_CITY_AT_THE_END_OF_THE_GAME, THE_CUTEST_PREDATOR, "end/root", THE_END_AGAIN, THE_END_STORY,
    THE_HEALING_POWER_OF_FRIENDSHIP, THE_NEXT_GENERATION, THE_PARROTS_AND_THE_BATS, THE_POWER_OF_BOOKS, THE_WHOLE_PACK,
    THIS_BOAT_HAS_LEGS, THOSE_WERE_THE_DAYS, TOTAL_BEELOCATION, TWO_BIRDS_ONE_ARROW, TWO_BY_TWO, UNDER_LOCK_AND_KEY,
    UNEASY_ALLIANCE, VERY_VERY_FRIGHTENING, VOLUNTARY_EXILE, WAR_PIGS, WAX_OFF, WAX_ON, WE_NEED_TO_GO_DEEPER,
    WHATEVER_FLOATS_YOUR_GOAT, WHAT_A_DEAL, WHEN_THE_SQUAD_HOPS_INTO_TOWN, WHOS_THE_PILLAGER_NOW, WHO_IS_CUTTING_ONIONS,
    WHO_NEEDS_ROCKETS, WITHERING_HEIGHTS, WITH_OUR_POWERS_COMBINED, YOUVE_GOT_A_FRIEND_IN_ME, YOU_NEED_A_MINT,
    ZOMBIE_DOCTOR
]
...
GAME_RULE_GROUP = [
    ...
    COMMAND_BLOCKS_WORK, COMMAND_BLOCK_OUTPUT, DROWNING_DAMAGE, ELYTRA_MOVEMENT_CHECK, ENDER_PEARLS_VANISH_ON_DEATH,
    ENTITY_DROPS, FALL_DAMAGE, FIRE_DAMAGE, FIRE_SPREAD_RADIUS_AROUND_PLAYER, FORGIVE_DEAD_PLAYERS, FREEZE_DAMAGE,
    GLOBAL_SOUND_EVENTS, IMMEDIATE_RESPAWN, KEEP_INVENTORY, LAVA_SOURCE_CONVERSION, LIMITED_CRAFTING, LOCATOR_BAR,
    LOG_ADMIN_COMMANDS, MAX_BLOCK_MODIFICATIONS, MAX_COMMAND_FORKS, MAX_COMMAND_SEQUENCE_LENGTH, MAX_ENTITY_CRAMMING,
    MAX_MINECART_SPEED, MAX_SNOW_ACCUMULATION_HEIGHT, MOB_DROPS, MOB_EXPLOSION_DROP_DECAY, MOB_GRIEFING,
    NATURAL_HEALTH_REGENERATION, PLAYERS_NETHER_PORTAL_CREATIVE_DELAY, PLAYERS_NETHER_PORTAL_DEFAULT_DELAY,
    PLAYERS_SLEEPING_PERCENTAGE, PLAYER_MOVEMENT_CHECK, PROJECTILES_CAN_BREAK_BLOCKS, PVP, RAIDS, RANDOM_TICK_SPEED,
    REDUCED_DEBUG_INFO, RESPAWN_RADIUS, SEND_COMMAND_FEEDBACK, SHOW_ADVANCEMENT_MESSAGES, SHOW_DEATH_MESSAGES,
    SPAWNER_BLOCKS_WORK, SPAWN_MOBS, SPAWN_MONSTERS, SPAWN_PATROLS, SPAWN_PHANTOMS, SPAWN_WANDERING_TRADERS,
    SPAWN_WARDENS, SPECTATORS_GENERATE_CHUNKS, SPREAD_VINES, TNT_EXPLODES, TNT_EXPLOSION_DROP_DECAY, UNIVERSAL_ANGER,
...
game_rules = {
    ...
    "ALLOW_ENTERING_NETHER_USING_PORTALS": GameRuleInfo("""allow Entering Nether Using Portals""",
                                                        "allow_entering_nether_using_portals",
                                                        """Controls whether players are allowed to enter the Nether.""",
                                                        bool),
    "BLOCK_DROPS": GameRuleInfo("""block Drops""", "block_drops", None, bool),
    "BLOCK_EXPLOSION_DROP_DECAY": GameRuleInfo("""block Explosion Drop Decay""", "block_explosion_drop_decay",
    ...
    "COMMAND_BLOCK_OUTPUT": GameRuleInfo("""command Block Output""", "command_block_output",
                                         """Broadcast command block output""", bool),
    ...
    "ENDER_PEARLS_VANISH_ON_DEATH": GameRuleInfo("""ender Pearls Vanish On Death""", "ender_pearls_vanish_on_death",
    ...
    "FIRE_SPREAD_RADIUS_AROUND_PLAYER": GameRuleInfo("""fire Spread Radius Around Player""",
                                                     "fire_spread_radius_around_player", None, int),
    "FORGIVE_DEAD_PLAYERS": GameRuleInfo("""forgive Dead Players""", "forgive_dead_players",
    ...
    "GLOBAL_SOUND_EVENTS": GameRuleInfo("""global Sound Events""", "global_sound_events",
    ...
    "LAVA_SOURCE_CONVERSION": GameRuleInfo("""lava Source Conversion""", "lava_source_conversion",
    ...
    "LOCATOR_BAR": GameRuleInfo("""locator Bar""", "locator_bar",
                                """When enabled, a bar is shown on the screen to indicate the direction of players.""",
                                bool),
    "LOG_ADMIN_COMMANDS": GameRuleInfo("""log Admin Commands""", "log_admin_commands", """Broadcast admin commands""",
                                       bool),
    ...
    "MAX_COMMAND_SEQUENCE_LENGTH": GameRuleInfo("""max Command Sequence Length""", "max_command_sequence_length", None,
                                                int),
    "MAX_ENTITY_CRAMMING": GameRuleInfo("""max Entity Cramming""", "max_entity_cramming",
                                        """Entity cramming threshold""", int),
    "MAX_MINECART_SPEED": GameRuleInfo("""max Minecart Speed""", "max_minecart_speed", None, int),
    "MAX_SNOW_ACCUMULATION_HEIGHT": GameRuleInfo("""max Snow Accumulation Height""", "max_snow_accumulation_height",
                                                 None, int),
    "MOB_DROPS": GameRuleInfo("""mob Drops""", "mob_drops", None, bool),
    "MOB_EXPLOSION_DROP_DECAY": GameRuleInfo("""mob Explosion Drop Decay""", "mob_explosion_drop_decay",
    ...
    "NATURAL_HEALTH_REGENERATION": GameRuleInfo("""natural Health Regeneration""", "natural_health_regeneration", None,
                                                bool),
    ...
    "PLAYERS_NETHER_PORTAL_DEFAULT_DELAY": GameRuleInfo("""players Nether Portal Default Delay""",
                                                        ...
                                                        int),
    "PLAYERS_SLEEPING_PERCENTAGE": GameRuleInfo("""players Sleeping Percentage""", "players_sleeping_percentage",
    ...
    "PROJECTILES_CAN_BREAK_BLOCKS": GameRuleInfo("""projectiles Can Break Blocks""", "projectiles_can_break_blocks",
    ...
    "REDUCED_DEBUG_INFO": GameRuleInfo("""reduced Debug Info""", "reduced_debug_info",
                                       """Limits contents of debug screen.""", bool),
    "RESPAWN_RADIUS": GameRuleInfo("""respawn Radius""", "respawn_radius", None, int),
    "SEND_COMMAND_FEEDBACK": GameRuleInfo("""send Command Feedback""", "send_command_feedback",
                                          """Send command feedback""", bool),
    "SHOW_ADVANCEMENT_MESSAGES": GameRuleInfo("""show Advancement Messages""", "show_advancement_messages", None, bool),
    "SHOW_DEATH_MESSAGES": GameRuleInfo("""show Death Messages""", "show_death_messages", """Show death messages""",
                                        bool),
    ...
    "SPAWN_MONSTERS": GameRuleInfo("""spawn Monsters""", "spawn_monsters",
                                   """Controls whether monsters naturally spawn.""", bool),
    ...
    "SPECTATORS_GENERATE_CHUNKS": GameRuleInfo("""spectators Generate Chunks""", "spectators_generate_chunks",
                                               """Allow spectators to generate terrain""", bool),
    "SPREAD_VINES": GameRuleInfo("""spread Vines""", "spread_vines", None, bool),
    "TNT_EXPLODES": GameRuleInfo("""tnt Explodes""", "tnt_explodes", """Allow TNT to be activated and to explode""",
                                 bool),
    "TNT_EXPLOSION_DROP_DECAY": GameRuleInfo("""tnt Explosion Drop Decay""", "tnt_explosion_drop_decay",
                                             """Some of the drops from blocks destroyed by explosions caused by TNT are lost in the explosion.""",
                                             bool),
    "UNIVERSAL_ANGER": GameRuleInfo("""universal Anger""", "universal_anger",
                                    ...
                                    bool),
    "WATER_SOURCE_CONVERSION": GameRuleInfo("""water Source Conversion""", "water_source_conversion",
...
particles = {
    ...
    "TRIAL_SPAWNER_DETECTION_OMINOUS": ParticleInfo("""Trial Spawner Detection Ominous""",
                                                    "trial_spawner_detection_ominous", None),
...
POTTERY_SHERD_GROUP = [
    ...
    GUSTER_POTTERY_SHERD, HEARTBREAK_POTTERY_SHERD, HEART_POTTERY_SHERD, HOWL_POTTERY_SHERD, MINER_POTTERY_SHERD,
...
WIND = "wind"
PAINTING_GROUP = [
    ALBANIAN, AZTEC2, BACKYARD, BAROQUE, BONJOUR_MONSIEUR_COURBET, BOUQUET, BUST, CAVEBIRD, CHANGING, COTÁN, CREEBET,
    DENNIS, DE_AZTEC, EARTH, ENDBOSS, FERN, FIGHTERS, FINDING, FIRE, GRAHAM, HUMBLE, KEBAB_MED_TRE_PEPPERONI, KONG,
    LOWMIST, MATCH, MEDITATIVE, MORTAL_COIL, ORB, OWLEMONS, PARADISTRÄD, PASSAGE, PIGSCENE, POINTER, POND, PRAIRIE_RIDE,
...
paintings = {
    ...
    "AZTEC2": PaintingInfo("""de_aztec""", "aztec2", None, "Kristoffer Zetterstrand", (1, 1)),
    ...
    "BONJOUR_MONSIEUR_COURBET": PaintingInfo("""Bonjour Monsieur Courbet""", "courbet", None, "Kristoffer Zetterstrand",
                                             (2, 1)),
    ...
    "KEBAB_MED_TRE_PEPPERONI": PaintingInfo("""Kebab med tre pepperoni""", "kebab", None, "Kristoffer Zetterstrand",
                                            (1, 1)),
    ...
    "TARGET_SUCCESSFULLY_BOMBED": PaintingInfo("""Target Successfully Bombed""", "bomb", None,
