...
# TeamOptions
# Derived from https://minecraft.wiki/Commands/team, 2024-04-03T17:19:42-07:00
__teamoption_dups = {}
...
# Patterns
# Derived from https://minecraft.wiki/Banner/Patterns, 2024-04-03T17:19:42-07:00
__pattern_dups = {}
BASE = "base"
...
# Advancements
# Derived from https://minecraft.wiki/Advancement#List_of_advancements, 2024-04-03T17:19:42-07:00
__advancement_dups = {}
...
ADVANCEMENT_GROUP = [
    ...
    UNDER_LOCK_AND_KEY, BLOWBACK, OVEROVERKILL, "husbandry/root", BEE_OUR_GUEST, THE_PARROTS_AND_THE_BATS,
    YOUVE_GOT_A_FRIEND_IN_ME, WHATEVER_FLOATS_YOUR_GOAT, BEST_FRIENDS_FOREVER, GLOW_AND_BEHOLD, FISHY_BUSINESS,
    TOTAL_BEELOCATION, BUKKIT_BUKKIT, SMELLS_INTERESTING, A_SEEDY_PLACE, WAX_ON, TWO_BY_TWO, BIRTHDAY_SONG,
    A_COMPLETE_CATALOGUE, TACTICAL_FISHING, WHEN_THE_SQUAD_HOPS_INTO_TOWN, LITTLE_SNIFFS, A_BALANCED_DIET,
    SERIOUS_DEDICATION, WAX_OFF, THE_CUTEST_PREDATOR, WITH_OUR_POWERS_COMBINED, PLANTING_THE_PAST,
...
advancements = {
    ...
    "LIGHTEN_UP": Advancement("""Lighten Up""", "adventure/lighten_up",
                              """Scrape a Copper Bulb with an Axe to make it brighter."""),
    "WHO_NEEDS_ROCKETS": Advancement("""Who Needs Rockets?""", "adventure/who_needs_rockets",
                                     """Use a Wind Charge to launch yourself upwards 7 blocks."""),
    "UNDER_LOCK_AND_KEY": Advancement("""Under Lock and Key""", "adventure/under_lock_and_key",
                                      """Use a Trial Key on a Vault."""),
    "BLOWBACK": Advancement("""Blowback""", "adventure/blowback",
...
# Biomes
# Derived from https://minecraft.wiki/Biome/ID, 2024-04-03T17:19:43-07:00
__biome_dups = {}
THE_VOID = "the_void"
...
biomes = {
    ...
    "OLD_GROWTH_BIRCH_FOREST": Biome("""Old Growth Birch Forest""", "old_growth_birch_forest",
                                     """Old Growth Birch Forest."""),
    "OLD_GROWTH_PINE_TAIGA": Biome("""Old Growth Pine Taiga""", "old_growth_pine_taiga", """Old Growth Pine Taiga."""),
    "OLD_GROWTH_SPRUCE_TAIGA": Biome("""Old Growth Spruce Taiga""", "old_growth_spruce_taiga",
    ...
    "WINDSWEPT_GRAVELLY_HILLS": Biome("""Windswept Gravelly Hills""", "windswept_gravelly_hills",
...
# Effects
# Derived from https://minecraft.wiki/Effect?so=search#Effect_list, 2024-04-03T17:19:43-07:00
__effect_dups = {}
SPEED = "speed"
SLOWNESS = "slowness"
HASTE = "haste"
...
# Enchantments
# Derived from https://minecraft.wiki/Enchanting#Summary_of_enchantments, 2024-04-03T17:29:04-07:00
__enchantment_dups = {}
...
# GameRules
# Derived from https://minecraft.wiki/Game_rule?so=search#List_of_game_rules, 2024-04-03T17:29:04-07:00
__gamerule_dups = {}
...
# ScoreCriteria
# Derived from https://minecraft.wiki/Scoreboard#Criteria, 2024-04-03T17:29:04-07:00
...
# Particles
# Derived from https://minecraft.wiki/Particles_(Java_Edition)#Types_of_particles, 2024-04-03T17:29:05-07:00
__particle_dups = {}
...
PARTICLE_GROUP = [
    ...
    GLOW_SQUID_INK, GUST, GUST_EMITTER, GUST_DUST, HAPPY_VILLAGER, HEART, "infested", INSTANT_EFFECT, ITEM, ITEM_COBWEB,
...
particles = {
    ...
    "REVERSE_PORTAL": Particle("""Reverse Portal""", "reverse_portal",
    ...
    "TRIAL_OMEN": Particle("""Trial Omen""", "trial_omen",
    ...
    "TRIAL_SPAWNER_DETECTION_OMINOUS": Particle("""Trial Spawner Detection Ominous""",
...
# PotterySherds
# Derived from https://minecraft.wiki/Pottery_Sherd, 2024-04-03T17:29:05-07:00
__potterysherd_dups = {}
