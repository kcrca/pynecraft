...
# Patterns
# Derived from https://minecraft.wiki/Banner/Patterns, 2024-02-22T23:58:46-08:00
BASE = "b"
BOTTOM_STRIPE = "bs"
TOP_STRIPE = "ts"
LEFT_STRIPE = "ls"
...
PIGLIN = "pig"
PATTERN_GROUP = [
    BASE, BOTTOM_STRIPE, TOP_STRIPE, LEFT_STRIPE, RIGHT_STRIPE, CENTER_STRIPE_VERTICAL, MIDDLE_STRIPE_HORIZONTAL, DOWN_RIGHT_STRIPE, DOWN_LEFT_STRIPE, SMALL_VERTICAL_STRIPES, DIAGONAL_CROSS, SQUARE_CROSS, LEFT_OF_DIAGONAL, RIGHT_OF_UPSIDEDOWN_DIAGONAL, LEFT_OF_UPSIDEDOWN_DIAGONAL, RIGHT_OF_DIAGONAL, VERTICAL_HALF_LEFT, VERTICAL_HALF_RIGHT, HORIZONTAL_HALF_TOP, HORIZONTAL_HALF_BOTTOM, BOTTOM_LEFT_CORNER, BOTTOM_RIGHT_CORNER, TOP_LEFT_CORNER, TOP_RIGHT_CORNER, BOTTOM_TRIANGLE, TOP_TRIANGLE, BOTTOM_TRIANGLE_SAWTOOTH, TOP_TRIANGLE_SAWTOOTH, MIDDLE_CIRCLE, MIDDLE_RHOMBUS, BORDER, CURLY_BORDER, BRICK, GRADIENT, GRADIENT_UPSIDEDOWN, CREEPER, SKULL, FLOWER, MOJANG, GLOBE, PIGLIN
]
...
# Advancements
# Derived from https://minecraft.wiki/Advancement#List_of_advancements, 2024-02-22T23:58:46-08:00
...
# BiomeIds
# Derived from https://minecraft.wiki/Biome/ID, 2024-02-22T23:58:46-08:00
THE_VOID = "the_void"
PLAINS = "plains"
...
biomeid = {
    ...
    "OLD_GROWTH_BIRCH_FOREST": BiomeId("""Old Growth Birch Forest""", "old_growth_birch_forest", """Old Growth Birch Forest."""), 
    "OLD_GROWTH_PINE_TAIGA": BiomeId("""Old Growth Pine Taiga""", "old_growth_pine_taiga", """Old Growth Pine Taiga."""), 
    "OLD_GROWTH_SPRUCE_TAIGA": BiomeId("""Old Growth Spruce Taiga""", "old_growth_spruce_taiga", """Old Growth Spruce Taiga."""), 
    ...
    "WINDSWEPT_GRAVELLY_HILLS": BiomeId("""Windswept Gravelly Hills""", "windswept_gravelly_hills", """Windswept Gravelly Hills."""), 
...
# Effects
# Derived from https://minecraft.wiki/Effect?so=search#Effect_list, 2024-02-22T23:58:46-08:00
SPEED = "speed"
SLOWNESS = "slowness"
HASTE = "haste"
...
DARKNESS = "darkness"
EFFECT_GROUP = [
    SPEED, SLOWNESS, HASTE, MINING_FATIGUE, STRENGTH, INSTANT_HEALTH, INSTANT_DAMAGE, JUMP_BOOST, NAUSEA, REGENERATION, RESISTANCE, FIRE_RESISTANCE, WATER_BREATHING, INVISIBILITY, BLINDNESS, NIGHT_VISION, HUNGER, WEAKNESS, POISON, WITHER, HEALTH_BOOST, ABSORPTION, SATURATION, GLOWING, LEVITATION, LUCK, BAD_LUCK, SLOW_FALLING, CONDUIT_POWER, DOLPHINS_GRACE, BAD_OMEN, HERO_OF_THE_VILLAGE, DARKNESS
]
...
# Enchantments
# Derived from https://minecraft.wiki/Enchanting#Summary_of_enchantments, 2024-02-22T23:58:46-08:00
...
enchantment = {
    ...
    "CHANNELING": Enchantment("""Channeling""", "channeling", """During thunderstorms, trident summons a lightning bolt on the target when hitting it.""", 1), 
...
# GameRules
# Derived from https://minecraft.wiki/Game_rule?so=search#List_of_game_rules, 2024-02-22T23:58:46-08:00
...
# ScoreCriterias
# Derived from https://minecraft.wiki/Scoreboard#Criteria, 2024-02-22T23:58:46-08:00
DUMMY = "dummy"
TRIGGER = "trigger"
...
scorecriteria = {
    "DUMMY": ScoreCriteria("""dummy""", "dummy", """Score is changed only by commands, and not by game events such as death. This is useful for event flags, state mappings, currencies,..."""), 
...
# Particles
# Derived from https://minecraft.wiki/Particles_(Java_Edition)#Types_of_particles, 2024-02-22T23:58:46-08:00
...
WITCH = "witch"
PARTICLE_GROUP = [
    AMBIENT_ENTITY_EFFECT, ANGRY_VILLAGER, ASH, BLOCK, BLOCK_MARKER, BUBBLE, BUBBLE_COLUMN_UP, BUBBLE_POP, CAMPFIRE_COSY_SMOKE, CAMPFIRE_SIGNAL_SMOKE, CHERRY_LEAVES, CLOUD, COMPOSTER, CRIMSON_SPORE, CRIT, CURRENT_DOWN, DAMAGE_INDICATOR, DOLPHIN, DRAGON_BREATH, DRIPPING_DRIPSTONE_LAVA, DRIPPING_DRIPSTONE_WATER, DRIPPING_HONEY, DRIPPING_LAVA, DRIPPING_OBSIDIAN_TEAR, DRIPPING_WATER, DUST, DUST_COLOR_TRANSITION, DUST_PLUME, EFFECT, EGG_CRACK, ELDER_GUARDIAN, ELECTRIC_SPARK, ENCHANT, ENCHANTED_HIT, END_ROD, ENTITY_EFFECT, EXPLOSION, EXPLOSION_EMITTER, FALLING_DRIPSTONE_LAVA, FALLING_DRIPSTONE_WATER, FALLING_DUST, FALLING_HONEY, FALLING_LAVA, FALLING_NECTAR, FALLING_OBSIDIAN_TEAR, FALLING_SPORE_BLOSSOM, FALLING_WATER, FIREWORK, FISHING, FLAME, FLASH, GLOW, GLOW_SQUID_INK, GUST, GUST_EMITTER, GUST_DUST, HAPPY_VILLAGER, HEART, INSTANT_EFFECT, ITEM, ITEM_SLIME, ITEM_SNOWBALL, LANDING_HONEY, LANDING_LAVA, LANDING_OBSIDIAN_TEAR, LARGE_SMOKE, LAVA, MYCELIUM, NAUTILUS, NOTE, POOF, PORTAL, RAIN, REVERSE_PORTAL, SCRAPE, SCULK_CHARGE, SCULK_CHARGE_POP, SCULK_SOUL, SHRIEK, SMALL_FLAME, SMOKE, SNEEZE, SNOWFLAKE, SONIC_BOOM, SOUL, SOUL_FIRE_FLAME, SPIT, SPLASH, SPORE_BLOSSOM_AIR, SQUID_INK, SWEEP_ATTACK, TOTEM_OF_UNDYING, TRIAL_SPAWNER_DETECTION, UNDERWATER, VAULT_CONNECTION, VIBRATION, WARPED_SPORE, WAX_OFF, WAX_ON, WHITE_ASH, WITCH
]
...
particle = {
    ...
    "VIBRATION": Particle("""Vibration""", "vibration", """Moves from sounds to the warden or a sculk sensor, moves froms note blocks to allays."""), 
...
# PotterySherds
# Derived from https://minecraft.wiki/Pottery_Sherd, 2024-02-22T23:58:46-08:00
