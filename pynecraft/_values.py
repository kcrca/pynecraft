...
SteppableInfo = namedtuple("Steppable", ['block', 'stairs', 'slab'])
steppable = (
    SteppableInfo('acacia_planks', 'acacia_stairs', 'acacia_slab'),
    SteppableInfo('andesite', 'andesite_stairs', 'andesite_slab'),
    ...
    SteppableInfo('cinnabar_bricks', 'cinnabar_brick_stairs', 'cinnabar_brick_slab'),
    SteppableInfo('cobbled_deepslate', 'cobbled_deepslate_stairs', 'cobbled_deepslate_slab'),
    ...
    SteppableInfo('deepslate_bricks', 'deepslate_brick_stairs', 'deepslate_brick_slab'),
    SteppableInfo('deepslate_tiles', 'deepslate_tile_stairs', 'deepslate_tile_slab'),
    SteppableInfo('diorite', 'diorite_stairs', 'diorite_slab'),
    ...
    SteppableInfo('mossy_stone_bricks', 'mossy_stone_brick_stairs', 'mossy_stone_brick_slab'),
    ...
    SteppableInfo('polished_blackstone_bricks', 'polished_blackstone_brick_stairs', 'polished_blackstone_brick_slab'),
    SteppableInfo('polished_cinnabar', 'polished_cinnabar_stairs', 'polished_cinnabar_slab'),
    SteppableInfo('polished_deepslate', 'polished_deepslate_stairs', 'polished_deepslate_slab'),
    SteppableInfo('polished_diorite', 'polished_diorite_stairs', 'polished_diorite_slab'),
    SteppableInfo('polished_granite', 'polished_granite_stairs', 'polished_granite_slab'),
    SteppableInfo('polished_sulfur', 'polished_sulfur_stairs', 'polished_sulfur_slab'),
    SteppableInfo('polished_tuff', 'polished_tuff_stairs', 'polished_tuff_slab'),
    ...
    SteppableInfo('resin_bricks', 'resin_brick_stairs', 'resin_brick_slab'),
    SteppableInfo('sandstone', 'sandstone_stairs', 'sandstone_slab'),
    SteppableInfo('smooth_quartz', 'smooth_quartz_stairs', 'smooth_quartz_slab'),
    SteppableInfo('smooth_red_sandstone', 'smooth_red_sandstone_stairs', 'smooth_red_sandstone_slab'),
    SteppableInfo('smooth_sandstone', 'smooth_sandstone_stairs', 'smooth_sandstone_slab'),
    SteppableInfo('spruce_planks', 'spruce_stairs', 'spruce_slab'),
    SteppableInfo('stone', 'stone_stairs', 'stone_slab'),
    SteppableInfo('stone_bricks', 'stone_brick_stairs', 'stone_brick_slab'),
    SteppableInfo('sulfur', 'sulfur_stairs', 'sulfur_slab'),
    SteppableInfo('sulfur_bricks', 'sulfur_brick_stairs', 'sulfur_brick_slab'),
    SteppableInfo('tuff', 'tuff_stairs', 'tuff_slab'),
    SteppableInfo('tuff_bricks', 'tuff_brick_stairs', 'tuff_brick_slab'),
    SteppableInfo('warped_planks', 'warped_stairs', 'warped_slab'),
    SteppableInfo('waxed_cut_copper', 'waxed_cut_copper_stairs', 'waxed_cut_copper_slab'),
    SteppableInfo('waxed_exposed_cut_copper', 'waxed_exposed_cut_copper_stairs', 'waxed_exposed_cut_copper_slab'),
...
ADVANCEMENT_GROUP = [
    ...
    THIS_BOAT_HAS_LEGS, THOSE_WERE_THE_DAYS, TOTAL_BEELOCATION, TWO_BIRDS_ONE_ARROW, TWO_BY_TWO, UH_OH,
    UNDER_LOCK_AND_KEY, UNEASY_ALLIANCE, VERY_VERY_FRIGHTENING, VOLUNTARY_EXILE, WAR_PIGS, WAX_OFF, WAX_ON,
    WE_NEED_TO_GO_DEEPER, WHATEVER_FLOATS_YOUR_GOAT, WHAT_A_DEAL, WHEN_THE_SQUAD_HOPS_INTO_TOWN, WHOS_THE_PILLAGER_NOW,
    WHO_IS_CUTTING_ONIONS, WHO_NEEDS_ROCKETS, WITHERING_HEIGHTS, WITH_OUR_POWERS_COMBINED, YOUVE_GOT_A_FRIEND_IN_ME,
...
DISC_GROUP = [
    BLOCKS, BOUNCE, CAT, CHIRP, CREATOR, CREATOR_MUSIC_BOX, ELEVEN, FAR, FIVE, LAVA_CHICKEN, MALL, MELLOHI, OTHERSIDE,
