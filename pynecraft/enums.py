...
class Effect(ValueEnum):
    ...
    @staticmethod
    def negative(effect):
      return effect.value in ['blindness', 'darkness', 'hunger', 'instant_damage', 'mining_fatigue', 'nausea', 'poison', 'slowness', 'unluck', 'weakness', 'wither']
